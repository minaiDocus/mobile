...
class CropperGrill extends Component{
  ...
  generateStyles(){
    this.styles = StyleSheet.create({
      ...
      coin: {
              backgroundColor:'rgba(215,215,255, 0.2)' //DONT FORGET THIS
            }
    })
  }
  ...
  render(){
    const coin =  {
                    backgroundColor:'rgba(150,150,255, 0.2)' //DONT FORGET THIS
                  }
    return <View style={[this.styles.content, {width: this.state.widthGrill, height: this.state.heightGrill}]}>
              <View style={{flex:1, flexDirection:'row'}}>
                <View style={[this.styles.grill, coin]} {...this.props.topLeftPan.panHandlers}/>
                {this.renderGrill(1)}
                <View style={[this.styles.grill, coin]} {...this.props.topRightPan.panHandlers}/>
              </View>
              <View style={{flex:1, flexDirection:'row'}}>
                {this.renderGrill(3)}
              </View>
              <View style={{flex:1, flexDirection:'row'}}>
                <View style={[this.styles.grill, coin]} {...this.props.bottomLeftPan.panHandlers}/>
                {this.renderGrill(1)}
                <View style={[this.styles.grill, coin]} {...this.props.bottomRightPan.panHandlers}/>
              </View>
           </View>
  }
}
...
export class CropperView extends Component{
  ...
  createFinaleImage(_url, width, height){
    ...
    this.final_image = {width: width, height: height, path: _url, filename: filename, mime: this.original_image.mime}
